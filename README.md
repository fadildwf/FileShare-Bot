...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/fadildwf/FileShare-Bot)</br>
...
#### Deploy in your VPS
````bash
git clone https://github.com/fhmyngrh/FileShare-Bot
cd File-Sharing-Bot
